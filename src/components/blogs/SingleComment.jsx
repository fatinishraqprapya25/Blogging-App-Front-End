...
export default function Comment({ comment, setComments }) {
    ...
    const handleReply = async () => {
        ...
        const response = await fetch(`https://blogging-app-api-using-express-mongo-db-iwvr.vercel.app/api/v1/comments/reply/${commentId}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": authorization
    ...
    return <>
        ...
        >
            <div>
                ...
                <div className="flex">
                    <button className="font-medium underline cursor-pointer text-sm text-gray-600" onClick={() => setShowReplyBox(!showReplyBox)}>reply</button>
        ...
        {showReplyBox && <div>
            <input className="border-0 rounded-md bg-gray-100 px-3 ms-3 py-1 outline-0 mr-2" type="text" value={replyValue} onChange={(e) => setReplyValue(e.target.value)} placeholder="Enter reply here" />
